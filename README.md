...
English| [中文](https://github.com/ontio/cross-chain/blob/master/btc/cross-chain_transaction_construction_tool_user_manual_CN.md)
...
| 为合约签名       | 商家使用多签中自己的比特币私钥对合约和Redeem签名，用于注册Redeem和合约。 |
